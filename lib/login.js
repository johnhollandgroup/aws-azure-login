...
const states = [{
    ...
    },
    {
        ...
        async handler(page, customDelayModifier, _selected, _noPrompt, _defaultUsername, _defaultPassword, rememberMe) {
            if (rememberMe) {
...
module.exports = {
    async loginAsync(profileName, mode, disableSandbox, noPrompt, enableChromeNetworkService, awsNoVerifySsl, enableChromeSeamlessSso, customDelayModifier, noDisableExtensions) {
     ...
     * @private
     */
    async _performLoginAsync(url, headless, disableSandbox, cliProxy, noPrompt, enableChromeNetworkService, defaultUsername, defaultPassword, enableChromeSeamlessSso, customDelayModifier, rememberMe, noDisableExtensions) {
